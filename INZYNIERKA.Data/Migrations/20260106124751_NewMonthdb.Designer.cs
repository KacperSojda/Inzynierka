...
namespace INZYNIERKA.Migrations
{
    ...
    [Migration("20260106124751_NewMonthdb")]
    partial class NewMonthdb
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("INZYNIERKA.Models.GroupMessage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("INZYNIERKA.Models.UserGroup", b =>
                {
                    b.Property<string>("UserId")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("INZYNIERKA.Models.GroupMessage", b =>
                {
                    b.HasOne("INZYNIERKA.Models.Group", "ChatGroup")
                        .WithMany("Messages")
