...
namespace INZYNIERKA.Services.Interfaces
{
    public interface IChatService<TUser> where TUser : User
    {
        ...
        Task<bool> SaveImage(string senderId, string receiverId, string imageData, string imageType);
        ...
        Task<bool> SaveGroupImage(string senderId, int groupId, string imageData, string imageType);
